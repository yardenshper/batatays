...
lib.ssMetadata = [
		{name:"batata_atlas_1", frames: [[638,0,1193,54],[1342,224,268,37],[0,0,636,323],[1092,112,778,54],[638,112,452,103],[638,56,1045,54],[1092,168,597,54],[1685,56,313,54],[1102,224,238,54],[1691,168,292,54],[638,224,462,54]]}
];
...
(lib.CachedBmp_11 = function() {
	this.initialize(ss["batata_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("rgba(211,211,211,0.447)").s().p("AiFDrQhOkRA9jCIE9gCQAfEFhBDQg");
	this.shape.setTransform(19.9041,41.4);
...
p.nominalBounds = new cjs.Rectangle(2.2,17.9,35.5,47.00000000000001);
...
p.nominalBounds = new cjs.Rectangle(0,0,596.5,27);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,153,255,0.698)").ss(3,0,1).p("");
	this.shape.setTransform(30.3875,33.25);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#AED4FF").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#F2D57A").ss(1,1,1).p("");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#C88E57").s().p("");
...
p.nominalBounds = new cjs.Rectangle(0,0,76.8,101.7);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:177.5,regY:139,rotation:44.9907,x:76.1,y:145.95},19).to({x:-279.25,y:239.5},8).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2,p:{regX:15.3,regY:16.3,rotation:142.532,x:198.8,y:88.5,scaleX:0.3222,scaleY:0.3222}}]},74).to({state:[{t:this.instance_3,p:{regX:15.3,regY:16.3,rotation:142.532,x:198.8,y:88.5,scaleX:0.3222,scaleY:0.3222}},{t:this.instance_2,p:{regX:15.4,regY:16.1,rotation:105.0381,x:211.8,y:64.1,scaleX:0.3222,scaleY:0.3222}}]},3).to({state:[{t:this.instance_4,p:{regX:15.3,regY:16.3,rotation:142.532,x:198.8,y:88.5}},{t:this.instance_3,p:{regX:15.4,regY:16.1,rotation:105.0381,x:211.8,y:64.1,scaleX:0.3222,scaleY:0.3222}},{t:this.instance_2,p:{regX:15.4,regY:16.1,rotation:105.0381,x:212.8,y:73.7,scaleX:0.3222,scaleY:0.3222}}]},4).to({state:[{t:this.instance_5,p:{regX:12.9,regY:16.4,rotation:142.532,x:199.4,y:88}},{t:this.instance_4,p:{regX:15.4,regY:16.1,rotation:105.0381,x:211.8,y:64.1}},{t:this.instance_3,p:{regX:15.4,regY:16.1,rotation:105.0381,x:212.8,y:73.7,scaleX:0.3222,scaleY:0.3222}},{t:this.instance_2,p:{regX:12.8,regY:16.4,rotation:-143.2511,x:145.4,y:72.4,scaleX:0.3222,scaleY:0.3222}}]},3).to({state:[{t:this.instance_6,p:{regX:12.9,regY:16.4,rotation:142.532,x:199.4,y:88}},{t:this.instance_5,p:{regX:15.4,regY:16.1,rotation:105.0381,x:211.8,y:64.1}},{t:this.instance_4,p:{regX:15.4,regY:16.1,rotation:105.0381,x:212.8,y:73.7}},{t:this.instance_3,p:{regX:12.8,regY:16.4,rotation:-143.2511,x:145.4,y:72.4,scaleX:0.3222,scaleY:0.3222}},{t:this.instance_2,p:{regX:12.7,regY:16.4,rotation:-104.0547,x:157.15,y:61.8,scaleX:0.3221,scaleY:0.3221}}]},4).to({state:[{t:this.instance_7},{t:this.instance_6,p:{regX:15.4,regY:16.1,rotation:105.0381,x:211.8,y:64.1}},{t:this.instance_5,p:{regX:15.4,regY:16.1,rotation:105.0381,x:212.8,y:73.7}},{t:this.instance_4,p:{regX:12.8,regY:16.4,rotation:-143.2511,x:145.4,y:72.4}},{t:this.instance_3,p:{regX:12.7,regY:16.4,rotation:-104.0547,x:157.15,y:61.8,scaleX:0.3221,scaleY:0.3221}},{t:this.instance_2,p:{regX:12.7,regY:16.4,rotation:-104.0547,x:151.15,y:82.3,scaleX:0.3221,scaleY:0.3221}}]},4).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_12}]},73).to({state:[{t:this.shape_13},{t:this.shape_12}]},6).to({state:[{t:this.shape_14},{t:this.shape_13}]},6).wait(69));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_15}]},39).to({state:[{t:this.shape_16}]},2).to({state:[{t:this.shape_17}]},4).to({state:[{t:this.shape_18}]},3).to({state:[{t:this.shape_19}]},2).to({state:[{t:this.shape_20}]},3).to({state:[{t:this.shape_21}]},3).to({state:[{t:this.shape_22}]},4).to({state:[{t:this.shape_23}]},4).to({state:[{t:this.shape_24}]},4).to({state:[{t:this.shape_25}]},3).to({state:[{t:this.shape_26}]},6).to({state:[{t:this.shape_27}]},7).to({state:[{t:this.shape_27}]},3).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({rotation:13.7419,x:169.7,y:97.9},19).wait(135));
...
if (reversed == null) { reversed = false; }
	...
	// Layer_11
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#BBA599").ss(9,1,1).p("AYfAAIHYAAA/2AAMAocAAAIP5AA");
	this.shape_1.setTransform(205.8,142.05);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#BBA599").ss(9,1,1).p("A/2AAMA/tAAA");
	this.shape_2.setTransform(205.8,142.05);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1}]}).to({state:[{t:this.shape_2}]},141).to({state:[]},1).wait(102));

	// Layer_12
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#BBA599").ss(9,1,1).p("A/YgJMA+xAAT");
	this.shape_3.setTransform(210.675,495.775);

	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(141).to({_off:true},1).wait(102));

	// Layer_13
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#BBA599").ss(9,1,1).p("EgASgstMAAlBZb");
	this.shape_4.setTransform(1.925,312.55);

	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(141).to({_off:true},1).wait(102));

	// Layer_14
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#BBA599").ss(9,1,1).p("EAAAgreMAAABW9");
	this.shape_5.setTransform(415.45,308.6);

	this.timeline.addTween(cjs.Tween.get(this.shape_5).wait(141).to({_off:true},1).wait(102));
...
p.nominalBounds = new cjs.Rectangle(0,36.6,274.7,127.20000000000002);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("rgba(0,153,255,0.698)").ss(3,0,1).p("");
	this.shape_8.setTransform(102.8652,160.125);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#AED4FF").s().p("");
	this.shape_9.setTransform(102.8652,160.125);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("rgba(0,153,255,0.698)").ss(3,0,1).p("");
	this.shape_10.setTransform(102.8915,154.425);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#AED4FF").s().p("");
	this.shape_11.setTransform(102.8915,154.425);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("rgba(0,153,255,0.698)").ss(3,0,1).p("");
	this.shape_12.setTransform(102.9826,148.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#AED4FF").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	// VASA
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,153,255,0.698)").ss(4,0,1).p("AADATIgDgFAgBgQIgBgC");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,153,255,0.698)").ss(4,0,1).p("AgCgdIgCgCAAGAfIgGgH");
...
if (reversed == null) { reversed = false; }
	...
	this.start.setTransform(262,174.95,1,1,0,0,0,67,77);

	this.timeline.addTween(cjs.Tween.get(this.start).to({_off:true},1).wait(622).to({_off:false},0).wait(1));

	// TXT
	this.instance = new lib.Symbol8("synched",0);
	this.instance.setTransform(324.7,99.25,1,1,0,0,0,298.2,13.4);

	this.instance_1 = new lib.CachedBmp_1();
	this.instance_1.setTransform(71.35,54.1,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},20).to({state:[{t:this.instance_1}]},30).to({state:[]},33).to({state:[{t:this.instance_2}]},24).to({state:[{t:this.instance_3}]},49).to({state:[]},36).to({state:[{t:this.instance_4}]},79).to({state:[{t:this.instance_5}]},48).to({state:[]},38).to({state:[{t:this.instance_6}]},9).to({state:[{t:this.instance_7}]},47).to({state:[{t:this.instance_8}]},136).to({state:[]},74).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},50).to({state:[{t:this.instance_11}]},142).to({state:[{t:this.instance_12}]},75).to({state:[{t:this.instance_13}]},52).to({state:[{t:this.instance_14,p:{regX:229.6,scaleX:1,scaleY:1,x:371.55,y:288.1,startPosition:0}}]},45).to({state:[{t:this.instance_14,p:{regX:229.5,scaleX:3.9303,scaleY:3.9303,x:549.95,y:488.65,startPosition:49}}]},49).to({state:[{t:this.instance_15}]},136).wait(74));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/batata_atlas_1.png", id:"batata_atlas_1"}
	],
	preloads: []
};
